...
<link rel="stylesheet" href="../css/style.css" type="text/css" />
 ...
 <body>
		...
		String title = "Delete Validation: " + validationId;
 		%>
	...
	<div class="popup-wrapper">
 	<form action = "../transaction/delete_validation.jsp" method="get">
		<div class="delform">
			<label>
				<span>Are you sure you want to delete validation '<%=validationId %>'?</span>
			</label>
